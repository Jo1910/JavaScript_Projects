...
function multipleMath() {
    ...
    document.getElementById('mltm').innerHTML = "8 plus 9 divided by 3, multiplied by 4 and then substracted by 1 equals " + Mulitple;
}

function remainderMath() {
    var Remainder = 33 % 14;
    document.getElementById('rmn').innerHTML = "When you divide 33 by 14 you have a remainder of: " + Remainder;
}
